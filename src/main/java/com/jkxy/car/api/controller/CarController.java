...
public class CarController {
    ...
    public JSONResult buyCar(@PathVariable int id, @PathVariable int carNum){
        //carService.updateById(car); //更新信息
        if (carService.buyCar(id, carNum)){
    ...
    @GetMapping("fuzzyQueries/{query}/{start}/{end}")
    public JSONResult fuzzyQueries(@PathVariable String query, @PathVariable int start, @PathVariable int end){
        List<Car> cars=carService.fuzzyQueries(query,start,end);
        return JSONResult.ok(cars);
    }//模糊查询
}
